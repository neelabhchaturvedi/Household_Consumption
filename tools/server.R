if (!exists("local_directory")) {  
  local_directory <- "~/Household_Forecast" 
...
shinyServer(function(input, output,session) {
  ...
  output$report = downloadHandler(
    filename <- function() {paste(paste('Household_Report',Sys.time() ),'.html')},
    
    content = function(file) {
      
      filename.Rmd <- paste('../doc/Household_Report', 'Rmd', sep=".")
      filename.md <- paste('../doc/Household_Report', 'md', sep=".")
      filename.html <- paste('../Household_Report', 'html', sep=".")
      ...
      file.copy(paste(local_directory,"doc/Household_Report.Rmd",sep="/"),filename.Rmd,overwrite=T)
  ...
  output$slide = downloadHandler(
    filename <- function() {paste(paste('Household_Slides',Sys.time() ),'.html')},
    
    content = function(file) {
      
      filename.Rmd <- paste('Household_Slides', 'Rmd', sep=".")
      filename.md <- paste('Household_Slides', 'md', sep=".")
      filename.html <- paste('Household_Slides', 'html', sep=".")
      ...
      file.copy(paste(local_directory,"doc/Household_Slides.Rmd",sep="/"),filename.Rmd,overwrite=T)
